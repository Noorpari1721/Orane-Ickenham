    ...
    <main className="relative min-h-screen overflow-x-clip bg-[#080808] pt-20 md:pt-0">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-3 py-4 sm:px-4 sm:py-6 md:px-6 md:py-8">
        <div
          ...
          className="relative overflow-clip rounded-[24px] border border-white/10 bg-white/[0.035] shadow-[0_30px_100px_rgba(0,0,0,.50)] backdrop-blur-3xl sm:rounded-[30px] lg:rounded-[38px]"
        >
          <div className="rounded-t-[24px] border-b border-white/10 px-4 py-5 sm:rounded-t-[30px] sm:px-6 sm:py-6 lg:rounded-t-[38px] lg:px-9">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 sm:justify-end">
                ...
                <motion.div
                  ...
                  className="rounded-full border border-[#D4AF37]/25 bg-[#D4AF37]/10 px-3 py-2 sm:px-5 sm:py-2.5"
                >
          ...
          >
            <div className="min-w-0 border-b border-white/10 px-4 py-5 sm:p-6 lg:border-b-0 lg:border-r lg:p-9">
              <motion.div
                initial={{
                  opacity: 0,
                  y: 18,
            ...
            {booking.step !== 7 && (
              <div className="relative self-stretch bg-black/20 px-4 pb-6 pt-6 sm:px-6 sm:pb-8 sm:pt-8 lg:px-8 lg:pb-8 lg:pt-8">
